...
public class TimeDelayRelayElm extends ChipElm {
    ...
    public TimeDelayRelayElm(CircuitDocument circuitDocument, int xx, int yy) {
    ...
    public TimeDelayRelayElm(CircuitDocument circuitDocument, int xa, int ya, int xb, int yb, int f,
                             StringTokenizer st) {
