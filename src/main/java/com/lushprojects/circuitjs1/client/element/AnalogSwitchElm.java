...
public class AnalogSwitchElm extends CircuitElm {
    ...
    public AnalogSwitchElm(CircuitDocument circuitDocument, int xx, int yy) {
    ...
    public AnalogSwitchElm(CircuitDocument circuitDocument, int xa, int ya, int xb, int yb, int f,
                           StringTokenizer st) {
    ...
    boolean isFlippedX() {
        return hasFlag(FLAG_FLIPPED_X);
    }

    boolean isFlippedY() {
        return hasFlag(FLAG_FLIPPED_Y);
    }

    boolean isFlipped() {
        return hasFlag(FLAG_FLIPPED);
    }
