...
public class CCCSElm extends VCCSElm {
    ...
    public CCCSElm(CircuitDocument circuitDocument, int xa, int ya, int xb, int yb, int f,
                   StringTokenizer st) {
...
//	    parseExpr();
    ...
    public CCCSElm(CircuitDocument circuitDocument, int xx, int yy) {
...
//                        sim.console("ccedx " + i + " " + cur + " " + dx + " " + rs + " " + sim.subIterations + " " + sim.t);
    ...
    public void setCurrentExprValue(int n, double cur) {
