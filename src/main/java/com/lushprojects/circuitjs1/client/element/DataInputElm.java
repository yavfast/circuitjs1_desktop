    ...
    static native String fetchLoadFileData(DataInputElm elm, Element uploadElement) /*-{
            ...
            if (oFiles.length >= 1) {
                        ...
                        reader.onload = function(e) {
                                ...
                                elm.@com.lushprojects.circuitjs1.client.element.DataInputElm::doLoadCallback(Ljava/lang/String;Ljava/lang/String;)(text, oFiles[0].name);
                        };
