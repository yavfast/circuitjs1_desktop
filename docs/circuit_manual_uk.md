...
### 21.7. Лінія передачі (Transmission Line)
**Код:** `171`
...
### 23.2. Джерело струму (Current Source)
**Код:** `i`
...
### 25.5. Перехресний перемикач (Cross Switch)
**Код:** `430`
